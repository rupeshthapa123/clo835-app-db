...
DBPORT = int(os.environ.get("DBPORT") or 3306)  # default 3306 if not set
...
# Generate a random color (can be overwritten by env or CLI)
...
def FetchData():
    ...
    if output:
        ...
        return render_template("getempoutput.html", error="No employee found", color=color_codes[COLOR])
